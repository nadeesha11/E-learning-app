...
public class Admin_CategoryActivity extends AppCompatActivity {
    ...
    public static List<Admin_CategoryModel> catList = new ArrayList<>();
    ...
    private Admin_CategoryAdapter adapter;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loadingDialog = new Dialog(Admin_CategoryActivity.this);
        loadingDialog.setContentView(R.layout.loading_progressbar);
        loadingDialog.setCancelable(false);
        loadingDialog.getWindow().setBackgroundDrawableResource(R.drawable.progress_background);
        loadingDialog.getWindow().setLayout(ViewGroup.LayoutParams.WRAP_CONTENT,ViewGroup.LayoutParams.WRAP_CONTENT);

        addCatDialog = new Dialog(Admin_CategoryActivity.this);
        ...
        firestore.collection("QUIZ1").document("Categories")
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                ...
                if(task.isSuccessful())
                {
                    ...
                    if(doc.exists())
                    {
                        ...
                        for(int i=1; i <= count; i++)
                        {
                            ...
                            catList.add(new Admin_CategoryModel(catid,catName,"0","1"));
                        }

                        adapter = new Admin_CategoryAdapter(catList);
                        cat_recycler_view.setAdapter(adapter);

                    }
                    else
                    {
                        Toast.makeText(Admin_CategoryActivity.this,"No Category Document Exists!",Toast.LENGTH_SHORT).show();
                        finish();
                    }
                ...
                else
                {
                    ...
                    Toast.makeText(Admin_CategoryActivity.this,task.getException().getMessage(),Toast.LENGTH_SHORT).show();
                }
    ...
    private void addNewCategory(final String title)
    {
        ...
        final String doc_id = firestore.collection("QUIZ1").document().getId();

        firestore.collection("QUIZ1").document(doc_id)
                .set(catData)
                        ...
                        firestore.collection("QUIZ1").document("Categories")
                                ...
                                .addOnSuccessListener(new OnSuccessListener<Void>() {
                                    ...
                                    public void onSuccess(Void aVoid) {
                                        ...
                                        Toast.makeText(Admin_CategoryActivity.this,"Category added successfully",Toast.LENGTH_SHORT).show();

                                        catList.add(new Admin_CategoryModel(doc_id,title,"0","1"));
                                ...
                                .addOnFailureListener(new OnFailureListener() {
                                    ...
                                    public void onFailure(@NonNull Exception e) {
                                        Toast.makeText(Admin_CategoryActivity.this,e.getMessage(),Toast.LENGTH_SHORT).show();
                                        loadingDialog.dismiss();
                                    }
                                });
