...
public class Admin_sets_activity extends AppCompatActivity {

    private RecyclerView setsView;
    private Button addSetB;
    private Admin_SetAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_setsactivity);
        ...
        loadingDialog = new Dialog(Admin_sets_activity.this);
    ...
    private void loadSets()
    {
        ...
        firestore.collection("QUIZ1").document(catList.get(selected_cat_index).getId())
            ...
            public void onSuccess(DocumentSnapshot documentSnapshot) {
                ...
                adapter = new Admin_SetAdapter(setsIDs);
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(Admin_sets_activity.this,e.getMessage(),Toast.LENGTH_SHORT).show();
                        loadingDialog.dismiss();
                    }
                });
    ...
    private void addNewSet()
    {
        ...
        firestore.collection("QUIZ1").document(curr_cat_id)
                        ...
                        firestore.collection("QUIZ1").document(curr_cat_id)
                                ...
                                .addOnSuccessListener(new OnSuccessListener<Void>() {
                                    ...
                                    public void onSuccess(Void aVoid) {
                                        ...
                                        Toast.makeText(Admin_sets_activity.this, " Set Added Successfully",Toast.LENGTH_SHORT).show();
