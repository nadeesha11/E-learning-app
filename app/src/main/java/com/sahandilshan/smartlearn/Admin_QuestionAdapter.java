...
import static com.sahandilshan.smartlearn.Admin_QuestionsActivity.quesList;
...
public class Admin_QuestionAdapter extends RecyclerView.Adapter<Admin_QuestionAdapter.ViewHolder> {

    private List<Admin_QuestionModel> ques_list;

    public Admin_QuestionAdapter(List<Admin_QuestionModel> ques_list) {
        this.ques_list = ques_list;
    }

    @NonNull
    @Override
    public Admin_QuestionAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
    ...
    @Override
    public void onBindViewHolder(@NonNull Admin_QuestionAdapter.ViewHolder viewHolder, int pos) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private void setData(final int pos, final Admin_QuestionAdapter adapter)
        {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent intent = new Intent(itemView.getContext(),Admin_QuestionDetails.class);
        ...
        private void deleteQuestion(final int pos, final Context context, final Admin_QuestionAdapter adapter)
        {
            loadingDialog.show();
