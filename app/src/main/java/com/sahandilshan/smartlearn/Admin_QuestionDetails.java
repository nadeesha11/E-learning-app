...
public class Admin_QuestionDetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin__question_details);
        ...
        loadingDialog = new Dialog(Admin_QuestionDetails.this);
    ...
    private void addNewQuestion()
    {
        ...
        final String doc_id = firestore.collection("QUIZ1").document(catList.get(selected_cat_index).getId())
                    ...
                    public void onSuccess(Void aVoid) {
                        ...
                        firestore.collection("QUIZ1").document(catList.get(selected_cat_index).getId())
                                ...
                                .addOnSuccessListener(new OnSuccessListener<Void>() {
                                    @Override
                                    public void onSuccess(Void aVoid) {
                                        Toast.makeText(Admin_QuestionDetails.this, " Question Added Successfully", Toast.LENGTH_SHORT).show();
                                        ...
                                        Admin_QuestionDetails.this.finish();
                                    }
                                })
                                .addOnFailureListener(new OnFailureListener() {
                                    @Override
                                    public void onFailure(@NonNull Exception e) {
                                        Toast.makeText(Admin_QuestionDetails.this,e.getMessage(),Toast.LENGTH_SHORT).show();
                                        loadingDialog.dismiss();
                                    }
                                });
        ...
        firestore.collection("QUIZ1").document(catList.get(selected_cat_index).getId())
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        ...
                        Toast.makeText(Admin_QuestionDetails.this,"Question updated successfully",Toast.LENGTH_SHORT).show();
