...
public class Admin_SetAdapter extends RecyclerView.Adapter<Admin_SetAdapter.ViewHolder> {

    private List<String> setIDs;

    public Admin_SetAdapter(List<String> setIDs) {
        this.setIDs = setIDs;
    }
    ...
    @NonNull
    @Override
    public Admin_SetAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.sets_item_layout,viewGroup,false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull Admin_SetAdapter.ViewHolder viewHolder, int i) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private void setData(final int pos, final String setID, final Admin_SetAdapter adapter)
        {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent = new Intent(itemView.getContext(),Admin_QuestionsActivity.class);
        ...
        private void deleteSet(final int pos, String setID, final Context context, final Admin_SetAdapter adapter)
        {
                                    ...
                                    firestore.collection("QUIZ1").document(catList.get(selected_cat_index).getId())
                                            ...
                                            .addOnSuccessListener(new OnSuccessListener<Void>() {
                                                ...
                                                public void onSuccess(Void aVoid) {
                                                    ...
                                                    com.sahandilshan.smartlearn.Admin_sets_activity.setsIDs.remove(pos);

                                                    catList.get(selected_cat_index).setNoOfSets(String.valueOf(com.sahandilshan.smartlearn.Admin_sets_activity.setsIDs.size()));
