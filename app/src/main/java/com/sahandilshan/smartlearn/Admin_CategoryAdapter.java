...
public class Admin_CategoryAdapter extends RecyclerView.Adapter<Admin_CategoryAdapter.ViewHolder> {
    ...
    private List<Admin_CategoryModel> cat_list;

    public Admin_CategoryAdapter(List<Admin_CategoryModel> cat_list) {
        this.cat_list = cat_list;
    }

    @NonNull
    @Override
    public Admin_CategoryAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
    ...
    @Override
    public void onBindViewHolder(@NonNull Admin_CategoryAdapter.ViewHolder viewHolder, int pos) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private void setData(String title, final int pos, final Admin_CategoryAdapter adapter)
        {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Admin_CategoryActivity.selected_cat_index = pos;
                    Intent intent = new Intent(itemView.getContext(),Admin_sets_activity.class);
        ...
        private void deleteCategory(final int id, final Context context, final Admin_CategoryAdapter adapter)
        {
            loadingDialog.show();
            ...
            firestore.collection("QUIZ1").document("Categories")
                    ...
                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                        ...
                        public void onSuccess(Void aVoid) {
                            ...
                            Admin_CategoryActivity.catList.remove(id);
        ...
        private void updateCategory(final String catNewName, final int pos, final Context context, final Admin_CategoryAdapter adapter)
        {
            editDialog.dismiss();
            ...
            firestore.collection("QUIZ1").document(cat_list.get(pos).getId())
                    .update(catData)
                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                        @Override
                        public void onSuccess(Void aVoid) {
                            ...
                            firestore.collection("QUIZ1").document("Categories")
                                    ...
                                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                                        ...
                                        public void onSuccess(Void aVoid) {
                                            ...
                                            Admin_CategoryActivity.catList.get(pos).setName(catNewName);
                                            adapter.notifyDataSetChanged();
